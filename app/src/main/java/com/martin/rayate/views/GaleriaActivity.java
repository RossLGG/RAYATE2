...
import com.martin.rayate.utils.listaAdaptador;
...
public class GaleriaActivity extends AppCompatActivity {
    ...
    private listaAdaptador mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new listaAdaptador(fileNameList,fileDoneList);
                ...
                for (int i = 0;i < totalItems; i++){
                    ...
                    fileToUpload.putFile(fileUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            //Toast.makeText(GaleriaActivity.this, "Done", Toast.LENGTH_SHORT).show();
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                        ...
                        PermissionListener dialogPermissionListener =
                                DialogOnDeniedPermissionListener.Builder
                                        .withContext(GaleriaActivity.this)
