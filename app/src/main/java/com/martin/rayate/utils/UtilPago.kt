...
object UtilPago {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(Constantes.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
        }
    }
    ...
    private fun directTokenizationSpecification(): JSONObject {
        if (Constantes.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME" ||
            (Constantes.DIRECT_TOKENIZATION_PARAMETERS.isEmpty() ||
                    Constantes.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty())) {
        ...
        return JSONObject().apply {
            put("type", "DIRECT")
            put("parameters", JSONObject(Constantes.DIRECT_TOKENIZATION_PARAMETERS))
        }
    }
     ...
     */
    private val allowedCardNetworks = JSONArray(Constantes.SUPPORTED_NETWORKS)
     ...
     * @see [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(Constantes.SUPPORTED_METHODS)
    ...
    private val merchantInfo: JSONObject
        ...
        get() = JSONObject().put("merchantName", "RAYATE!")
    ...
    fun createPaymentsClient(activity: Activity): PaymentsClient {
        val walletOptions = Wallet.WalletOptions.Builder()
            .setEnvironment(Constantes.PAYMENTS_ENVIRONMENT)
            .build()
    ...
    private fun getTransactionInfo(price: String): JSONObject {
        return JSONObject().apply {
            ...
            put("countryCode", Constantes.COUNTRY_CODE)
            put("currencyCode", Constantes.CURRENCY_CODE)
        }
    }
        ...
        try {
            return JSONObject(baseRequest.toString()).apply {
                ...
                val shippingAddressParameters = JSONObject().apply {
                    ...
                    put("allowedCountryCodes", JSONArray(Constantes.SHIPPING_SUPPORTED_COUNTRIES))
                }
